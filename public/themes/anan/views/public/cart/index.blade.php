...
@push('styles')
    ...
    <style>
        ...
        .cart-collaterals .wc-proceed-to-checkout .bk-btn button {
            width: 100% !important;
        }
                        ...
                        <div>
                            <div class="card-body cart">
                                <div class="col-sm-12 empty-cart-cls text-center"><img
                                    ...
                                    <h4>Add something to make me happy :)</h4> <a href="{{ route('home') }}"
                                    ...
                                    <div class="hsg-rich-text">
                                        <div class="hsg-rich-text__wrapper post-content__wrapper blog-postPage-content">
                                            <div class="woocommerce">
                                                <form class="woocommerce-cart-form" action="{{ route('cart.update') }}"
                                                      method="post">
                                                    @csrf
                                                            ...
                                                            <table
                                                                    ...
                                                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                                                        <td class="product-remove">
                                                                            <a href="#" class="remove btn-remove-item"
                                                                               data-id="{{ $cart->id }}">&times;</a>
                                                                        </td>
                                                                        <td class="product-thumbnail">
                                                                            <a href="{{ route('product.single', ['slug' => $cart->product->slug]) }}">
                                                                                <img width="300" height="300"
                                                                                     src="{{ $cart->product->base_image->path }}"
                                                                                     class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail bk-product-image"
                                                                                     alt="{{ $cart->product->name }}"
                                                                                     loading="lazy"/>
                                                                            </a>
                                                                        </td>
                                                                        <td class="product-name" data-title="Sản phẩm">
                                                                            <a class="bk-product-name" href="{{ route('product.single', ['slug' => $cart->product->slug]) }}">
                                                                                {{ $cart->product->name }}
                                                                            </a>
                                                                        </td>
                                                                        <td class="product-price" data-title="Giá">
                                                                            <span class="woocommerce-Price-amount amount bk-product-price">{{ $cart->product->selling_price->format() }}</span>
                                                                        </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="6" class="actions">
                                                                        <button type="button"
                                                                                class="button btn-redirecthome">Tiếp
                                                                            tục mua hàng
                                                                        </button>
                                                            ...
                                                            <div class="az-coupon">
                                                                <div class="coupon">
                                                                    ...
                                                                    <div class="az-form-coupon">
                                                                        ...
                                                                        <button type="submit" class="button"
                                                                                name="apply_coupon" id="apply-coupon"
