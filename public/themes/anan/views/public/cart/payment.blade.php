                                    ...
                                    <div class="woocommerce">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="{{ route('cart.postCheckout') }}" method="post">
                                                @csrf
                                                <div class="col2-set row az-billing mt-30 mb-30" id="customer_details">
                                                    <div class="col-md-6">
                                                            ...
                                                            <div class="woocommerce-billing-fields__field-wrapper">
                                                                ...
                                                                <p class="form-row form-row-first validate-required validate-phone"
                                                                    id="billing_phone_field" data-priority="20"><label
                                                                        ...
                                                                        class="woocommerce-input-wrapper"><input
                                                                            ...
                                                                            name="phone" id="phone"
                                                                            placeholder="Số điện thoại của bạn" value="{{ old('phone') }}" /></span>
                                                                ...
                                                                <p class="form-row form-row-last validate-required validate-email"
                                                                    id="billing_email_field" data-priority="21"><label
                                                                        ...
                                                                        class="woocommerce-input-wrapper"><input
                                                                            ...
                                                                            name="email" id="email"
                                                                            placeholder="Email của bạn" value="{{ old('email') }}" /></span>
                                                                ...
                                                                <p class="form-row form-row-first address-field update_totals_on_change validate-required"
                                                                    ...
                                                                    <span class="woocommerce-input-wrapper">
                                                                        <select name="province" id="province"
                                                                            class="select " value="{{ old('province') }}"
                                                                ...
                                                                <p class="form-row form-row-last address-field update_totals_on_change validate-required validate-required"
                                                                    ...
                                                                    <select name="district" id="district"
                                                                        class="select "
                                                                        data-placeholder="Chọn quận huyện" value="{{ old('district') }}">
                                                                        <option value="" selected='selected'>Chọn quận
                                                                            huyện</option>
                                                                    </select>
                                                                ...
                                                                <p class="form-row form-row-last validate-required"
                                                                    ...
                                                                    <label for="billing_address_1" class="">Địa
                                                                        ...
                                                                        class="woocommerce-input-wrapper"><input
                                                                            ...
                                                                            name="address"
                                                                            id="address"
                                                                            placeholder="Ví dụ: Số 20, ngõ 90" value="{{ old('address') }}"/></span>
                                                                    ...
                                                                    <p class="form-row notes" id="order_comments_field"
                                                                        data-priority=""><label for="note"
                                                                            ...
                                                                            class="woocommerce-input-wrapper"><textarea
                                                                                ...
                                                                                rows="2" cols="5" value="{{ old('note') }}"></textarea></span></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div id="payment" class="woocommerce-checkout-payment">
                                                                <ul class="wc_payment_methods payment_methods methods">
                                                                    ...
                                                                    <li class="wc_payment_method payment_method_{{ $key }}">
                                                                        <input id="payment_method_{{ $key }}" type="radio"
                                                                ...
                                                                <div class="form-row place-order">
                                                                    <noscript>
                                                                        ...
                                                                        hoặc nó bị vô hiệu
                                                                        hóa, hãy đảm bảo bạn nhấp vào <em>Cập nhật giỏ
                                                                            hàng</em> trước
                                                                        khi bạn thanh toán. Bạn có thể phải trả nhiều
                                                                        hơn số tiền đã
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="woocommerce-privacy-policy-text">
                                                                            <p>Thông tin cá nhân của bạn sẽ được sử dụng
                                                                                để xử lý đơn
                                                                                hàng, tăng trải nghiệm sử dụng website,
                                                                                và cho các mục
                                                                                đích cụ thể khác đã được mô tả trong <a
                                                                                    href="/chinh-sach-bao-mat-thong-tin-khach-hang/"
                                                                                    rel="noopener" target="_blank">Chính
                                                                                    sách riêng
                                                                                    tư</a>.</p>
                                                                        </div>
                                                                    </div>
