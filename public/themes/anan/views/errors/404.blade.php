...
@section('title', trans('anan::404.404'))
        ...
        <div class="container">
            <div class="row error-page">
                <div class="col-xl-7 col-lg-8 col-md-18 error-page-left">
                    <h1 class="section-title">{{ trans('anan::404.page_not_found') }}</h1>

                    <p>{{ trans('anan::404.unable_to_find_the_page') }}</p>

                    <a href="{{ route('home') }}" class="btn btn-default btn-back-to-home">
                        {{ trans('anan::404.back_to_home') }}
                    </a>
                </div>
