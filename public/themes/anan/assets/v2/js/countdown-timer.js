document.addEventListener('DOMContentLoaded', function () {
    ...
    countdownSingleProduct.forEach(el => {
        ...
        const updateCountdown = () => {
            ...
            if (days > 0) {
                el.textContent = `💥Kết thúc sau ${String(days).padStart(2, '0')} ngày ${String(hours).padStart(2, '0')}:${String(minutes).padStart(2, '0')}:${String(seconds).padStart(2, '0')}`;
            } else if (hours > 0) {
                el.textContent = `💥Kết thúc sau ${String(hours).padStart(2, '0')} giờ ${String(minutes).padStart(2, '0')}:${String(seconds).padStart(2, '0')}`;
            } else {
                el.textContent = `💥Kết thúc sau ${String(minutes).padStart(2, '0')} phút ${String(seconds).padStart(2, '0')} giây`;
            }
        };
