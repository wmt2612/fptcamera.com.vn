...
class ConfigMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'theme:make-config';
    ...
    protected function getTemplateContents()
    {
        return (new Stub($this->getStubName(), [
            'NAMESPACE' => 'Themes\\'. $this->getThemeName() .'\\Http\Controllers\Admin',
    ...
    {
        $path = public_path("themes\\".$this->getThemeName() ."\\Http\Controllers\\Admin\\");
        $public = $path . $this->getThemeName() .'Controller.php';
        return $public;
    }
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'The name of the admin controller.'],
        ];
    }
