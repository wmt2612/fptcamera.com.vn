...
class ResourceAssetCssMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new resource css.';
    ...
    {
        $path = public_path("themes\\".$this->getThemeName() ."\\resources\\assets\\admin\\sass\\");
        $public = $path . 'main.scss';
        return $public;
    }
