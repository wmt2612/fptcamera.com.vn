...
class WebpackMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'theme:make-webpack';
     ...
     * @var string
     */
    protected $description = 'Create a new webpack.';
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'The name of the webpack.'],
        ];
    }
