...
export default class extends BaseOption {
    constructor() {
        ...
        this.addOptions(FleetCart.data['service.options']);
        ...
        super.addOptionsErrors(FleetCart.errors['service.options']);
    ...
    addOption(option = { id: null, name: null, type: null, is_required: false, values: [] }) {
        ...
        let template = _.template($('#option-service-template').html());
        let html = $(template({ option, optionId, listProvinces }));
