                ...
                <div class="tab-content">
                    <div id="slides-<%- slideNumber %>-general" class="general tab-pane fade in active">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label for="slides[<%- slideNumber %>][call-to-action-text-2]">
                                        {{ trans('slider::attributes.call_to_action_text') }} 2
                                    </label>

                                    <input type="text"
                                        name="slides[<%- slideNumber %>][call_to_action_text_2]"
                                        class="form-control"
                                        id="slides[<%- slideNumber %>][call-to-action-text-2]"
                                        value="<%- slide.call_to_action_text_2 %>"
                                    >
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label for="slides-<%- slideNumber %>-call-to-action-url-2">
                                        {{ trans('slider::attributes.call_to_action_url') }} 2
                                    </label>

                                    <input type="text"
                                        name="slides[<%- slideNumber %>][call_to_action_url_2]"
                                        class="form-control"
                                        id="slides-<%- slideNumber %>-call-to-action-url-2"
                                        value="<%- slide.call_to_action_url_2 %>"
                                    >
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="slider-<%- slideNumber %>-options" class="tab-pane fade in clearfix">
                        <select class="change-option-block custom-select-black pull-right">
                            ...
                            <option value="call-to-action-2">{{ trans('slider::sliders.slide.form.call_to_action') }} 2</option>
                        </select>
                        ...
                        @include('slider::admin.sliders.templates.partials.slide_call_to_action_2')
                    </div>
                </div>
            </div>
        </div>
