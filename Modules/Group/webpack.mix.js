...
mix.js(`${__dirname}/Resources/assets/admin/js/main.js`, `${__dirname}/Assets/admin/js/group.js`)
    .scripts(`${__dirname}/node_modules/jstree/dist/jstree.js`, `${__dirname}/Assets/admin/js/jstree.js`)
    .sass(`${__dirname}/Resources/assets/admin/sass/main.scss`, `${__dirname}/Assets/admin/css/group.css`)
