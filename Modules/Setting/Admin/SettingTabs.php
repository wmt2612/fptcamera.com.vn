...
class SettingTabs extends Tabs
{
    ...
    private function themes()
    {
        ...
        // Setting::set('active_theme', 'Tran Tai');

        return tap(new Tab('themes', trans('setting::settings.tabs.themes')), function (Tab $tab) {
            $tab->weight(5);
            $tab->view('setting::admin.settings.tabs.option_theme', [
                'themes' => Theme::all(),
            ]);
        });
    }
